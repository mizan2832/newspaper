        ...
        <div class="row">
                          ...
                          @foreach ($news as $ne)
                            ...
                            <div class="col-12 col-lg-6">
                                ...
                                <div class="single-blog-post featured-post-2">
                                    ...
                                    <div class="post-data">
                                        <a href="/news/{{ $category_name }}" class="post-catagory">{{ $category_name }}</a>
                                        <div class="post-meta">
                                            <a href="/details/{{ $category_name }}/{{ strtolower(str_replace(' ','_',$ne->title)) }}/{{ $ne->id }}" class="post-title">
                                                <h6>{!! $ne->title !!}</h6>
                                            </a>
            ...
            <div class="col-12 col-lg-4">
                ...
                <div class="single-blog-post small-featured-post d-flex">
                    ...
                    <div class="post-data">
                        <a href="{!! strtolower($categorynews[$key]->category_name)!!}" class="post-catagory">{!! $categorynews[$key]->category_name !!}</a>
                        <div class="post-meta">
                            <a href="/details/{!! strtolower($categorynews[$key]->category_name)!!}/{{ strtolower(str_replace(' ','_',$ne->title)) }}/{{ $ne->id }}">
                                <h6>{{ $ne->title }}</h6>
                            </a>
                            <p class="post-date">{{ Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $ne->created_at)->format('g:iA') }}
