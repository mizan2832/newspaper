<div class="video-post-area bg-img bg-overlay" style="background-image: url(front/img/bg-img/bg1.jpg);">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 col-lg-9">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/1.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/2.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-title">
                                    <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/3.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-title">
                                    <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/4.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-title">
                                    <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/5.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-title">
                                    <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
                    ...
                    <div class="col-12 col-lg-4">
                        <div class="single-blog-post">
                            <div class="post-thumb">
                                <a href="#"><img src=" {{ asset('front/img/bg-img/6.jpg') }}" alt=""></a>
                            </div>
                            <div class="post-data">
                                <a href="#" class="post-title">
                                    <h6>Orci varius natoque penatibus et magnis dis parturient montes.</h6>
            ...
            <div class="col-12 col-md-5 col-lg-3">
                ...
                <div class="single-blog-post style-2">
                    <div class="post-thumb">
                        <a href="#"><img src=" {{ asset('front/img/bg-img/7.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-data">
                        <a href="#" class="post-title">
                ...
                <div class="single-blog-post style-2">
                    <div class="post-thumb">
                        <a href="#"><img src=" {{ asset('front/img/bg-img/8.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-data">
                        <a href="#" class="post-title">
                            <h6>Orci varius natoque penatibus et magnis</h6>
                ...
                <div class="single-blog-post style-2">
                    <div class="post-thumb">
                        <a href="#"><img src=" {{ asset('front/') }}img/bg-img/9.jpg" alt=""></a>
                    </div>
                    <div class="post-data">
                        <a href="#" class="post-title">
                            <h6>Orci varius natoque penatibus et magnis</h6>
                ...
                <div class="single-blog-post style-2">
                    <div class="post-thumb">
                        <a href="#"><img src=" {{ asset('front/') }}img/bg-img/10.jpg" alt=""></a>
                    </div>
                    <div class="post-data">
                        <a href="#" class="post-title">
                            <h6>Orci varius natoque penatibus et magnis</h6>
                ...
                <div class="single-blog-post style-2">
                    <div class="post-thumb">
                        <a href="#"><img src=" {{ asset('front/') }}img/bg-img/11.jpg" alt=""></a>
                    </div>
                    <div class="post-data">
                        <a href="#" class="post-title">
                            <h6>Orci varius natoque penatibus et magnis</h6>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer-add">
                    <a href="#"><img src=" {{ asset('front/img/bg-img/footer-add.gif') }}" alt=""></a>
                </div>
            </div>
        </div>
    </div>
